...
public class ListingFeedPresenter : IInitializable, IDisposable
{
	...
	public ListingFeedPresenter(ListingFeedPostsView view, ListingFeedModel model, CreateNewPostPresenter createNewPostPresenter, StartUp startUp, ConfirmEmailPresenter confirmEmailPresenter)
	{
		_view = view;
		_model = model;
